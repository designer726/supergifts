...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        $stmt = $conn->prepare("INSERT INTO employee_testimonials (photo, quote, employee_name, role, sequence, status) VALUES (?,?,?,?,?,?)");
        $stmt->bind_param("ssssii", $photo, $quote, $employee_name, $role, $sequence, $status);
        if ($stmt->execute()) {
...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <h5 class="mb-0 fw-bold">Add Employee Review</h5>
</div>
...
<form method="POST" enctype="multipart/form-data">
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="form-card mb-4">
                ...
                <textarea name="quote" class="form-control" rows="6" placeholder="Super Gifts has given me the perfect platform to learn, grow and make a real impact..."><?= htmlspecialchars($quote) ?></textarea>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="form-card mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="employee_name" class="form-control" value="<?= htmlspecialchars($employee_name) ?>" placeholder="Arbaz Jalmani">
                </div>
                <div class="mb-0">
                    <label class="form-label">Role / Designation</label>
                    <input type="text" name="role" class="form-control" value="<?= htmlspecialchars($role) ?>" placeholder="Senior Designer">
                </div>
            </div>
            ...
            <div class="form-card mb-4">
                ...
                <div class="text-muted small mt-2">Square headshot works best. Max 2MB.</div>
            </div>
    ...
    <div class="mt-4 d-flex gap-3">
        <button type="submit" class="btn btn-gold px-5"><i class="bi bi-save me-2"></i>Save Review</button>
