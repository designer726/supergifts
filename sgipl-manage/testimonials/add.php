...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        $stmt = $conn->prepare("INSERT INTO client_testimonials (headline, content, client_name, client_location, avatar, image, sequence, status) VALUES (?,?,?,?,?,?,?,?)");
        $stmt->bind_param("ssssssii", $headline, $content, $client_name, $client_location, $avatar, $image, $sequence, $status);
        if ($stmt->execute()) {
...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <h5 class="mb-0 fw-bold">Add Testimonial</h5>
</div>
...
<form method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-4">
            <div class="form-card mb-4">
                ...
                <div class="mb-0">
                    ...
                    <div class="text-muted small mt-1">Small circular photo next to the name. Leave empty to show the client's initial instead.</div>
                </div>
            </div>
            ...
            <div class="form-card mb-4">
                ...
                <div class="text-muted small mt-2">The photo shown on the right side of the card (e.g. the gift box supplied). Square-ish images work best.</div>
            </div>
    ...
    <div class="mt-4 d-flex gap-3">
        <button type="submit" class="btn btn-gold px-5"><i class="bi bi-save me-2"></i>Save Testimonial</button>
